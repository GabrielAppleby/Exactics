...
namespace Entitas {
    public partial class Entity {
        ...
        public Entity AddPosition(float newX, float newY, int newFakeX, int newFakeY) {
            var component = CreateComponent<PositionComponent>(ComponentIds.Position);
            component.x = newX;
            component.y = newY;
            component.fakeX = newFakeX;
            component.fakeY = newFakeY;
            return AddComponent(ComponentIds.Position, component);
        }

        public Entity ReplacePosition(float newX, float newY, int newFakeX, int newFakeY) {
            var component = CreateComponent<PositionComponent>(ComponentIds.Position);
            component.x = newX;
            component.y = newY;
            component.fakeX = newFakeX;
